...
import com.graccasoft.bookspa.model.dto.BookingReportDto;
import com.graccasoft.bookspa.model.dto.TimeSlot;
...
import com.graccasoft.bookspa.model.mapper.BookingMapper;
import com.graccasoft.bookspa.model.mapper.BookingReportMapper;
import com.graccasoft.bookspa.model.mapper.ClientMapper;
import com.graccasoft.bookspa.repository.BookingRepository;
...
public class BookingService {
    ...
    public BookingDto getBooking(Long bookingId){
        return bookingMapper.toDto(
                bookingRepository
                        .findById(bookingId)
                        .orElseThrow(()-> new RecordNotFoundException("Booking with ID not found"))
        );
    }
